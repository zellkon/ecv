...
var storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, '/home/ubuntu/ecv/public/upload')
  },
...
router.get('/danh-sach.html', checkLogin, function (req, res) {
...
router.get('/them-product.html', checkLogin, function (req, res) {
...
router.post('/them-product.html', checkLogin, upload.single('hinh'), function (req, res) {
	...
	if (errors) {
		var file = '/home/ubuntu/ecv/public/upload/' + req.file.filename;
		  var fs = require('fs');
...
router.post('/:id/sua-product.html',  upload.single('hinh'), function (req, res) {
	...
	if (errors) {
		...
		Product.findOne({ _id: req.params.id},  function(err, data){
			var file = '/home/ubuntu/ecv/public/upload/' + data.img;
			var fs = require('fs');
			fs.unlink(file, function(e){
				if(e) throw e;
			 });
...
router.get('/:id/xoa-product.html', checkLogin,  function (req, res) {
